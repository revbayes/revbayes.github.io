...
# files
RATE_FN="./input/multifig/results/multifig"  # no file extension
PHY_FN="./input/multifig/results/multifig.tre"
ANC_FN="./input/multifig/results/multifig.states.txt"
MODEL_FN="./input/multifig/results/multifig.model.txt"
RANGE_FN="./input/multifig/kadua/kadua_range_n7.nex"
LABEL_FN="./input/multifig/kadua/kadua_range_label.csv"
AGE_FN="./input/multifig/hawaii/age_summary.csv"
FEAT_FN="./input/multifig/hawaii/feature_summary.csv"
DESC_FN="./input/multifig/hawaii/feature_description.csv"
