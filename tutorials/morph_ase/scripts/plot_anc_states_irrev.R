################################################################################
#
# Plot ancestral state estimates inferred using the irreversible rates models of character evolution.
#
#
...
tree_file <- paste0("output/",CHARACTER,"_ase_irrev.tree")
...
ggsave(paste0("Primates_",CHARACTER,"_ASE_irrev_MAP.pdf"), p, width = 11, height = 9)
...
ggsave(paste0("Primates_",CHARACTER,"_ASE_irrev_Pie.pdf"), p, width = 11, height = 9)
