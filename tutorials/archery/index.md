...
Figure [fig:archery_model] shows the graphical model for the archery
...
![]( figures/archery_MCMC_Trace.png) ![](
figures/archery_MCMC_distribution.png) 
> he *Trace* of sample from
an MCMC simulation. Right: The approximated posterior probability
distribution for $\mu$.
