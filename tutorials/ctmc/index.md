...
prerequisites:
- intro
files: ['primates_and_galeopterus_cytb.nex']
---
...
Note that we are adding two new variables to our model. We can define a `pi`
...
rates; ([*i.e.*]{}, a relatively [*informative*]{} prior).
