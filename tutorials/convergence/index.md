...
The function `checkConvergence` takes the output from a phylogenetic analysis performed with RevBayes and works through the convergence assessment pipeline.
