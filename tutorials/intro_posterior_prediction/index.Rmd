...
<link rel="icon" type="image/png" href="/assets/img/favicon.png" >
  ...
  <h5>Last modified on October 23, 2022</h5>
</div>
...
<blockquote class="tutorial_files" id="tutorial_files">
    <h2>Data files and scripts</h2>
        ...
        <ul id="data_files">
          ...
          <li><a href="/tutorials/intro_posterior_prediction/data/twoNormals_posterior.log">twoNormals_posterior.log</a></li>
        ...
        <ul id="scripts">
          ...
          <li><a href="/tutorials/intro_posterior_prediction/scripts/MCMC_SingleNormal.rev">MCMC_SingleNormal.rev</a></li>
        
          <li><a href="/tutorials/intro_posterior_prediction/scripts/MCMC_TwoNormals.rev">MCMC_TwoNormals.rev</a></li>
        
          <li><a href="/tutorials/intro_posterior_prediction/scripts/pps_SingleNormal.rev">pps_SingleNormal.rev</a></li>
        
          <li><a href="/tutorials/intro_posterior_prediction/scripts/pps_TwoNormals.rev">pps_TwoNormals.rev</a></li>
...
<figcaption>A single Normal distribution fit to the population trait values (based on one draw of the mean and standard deviation sampled during MCMC).</figcaption>
</figure>
...
<figcaption>Simulation of posterior predictive datasets (shown in light gray) by drawing samples of means and standard deviations from the posterior distribution.</figcaption>
</figure>
...
using both posterior predictive p-values and effect sizes. Figure from <a class="citation" href="#Hoehna2018a">Höhna et al. (2018)</a>.</figcaption>
</figure>
...
<ol class="bibliography"><li><span id="BrownThomson2018">Brown J.M., Thomson R.C. 2018. Evaluating model performance in evolutionary biology. Annual Review of Ecology, Evolution, and Systematics. 49:95–114.</span>

<a href="https://doi.org/10.1146/annurev-ecolsys-110617-062249">10.1146/annurev-ecolsys-110617-062249</a>
