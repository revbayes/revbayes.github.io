...
rev_out <- rev.process.div.rates(speciation_times_file ="output2/m1_un5_speciation_times.log", 
                                 speciation_rates_file="output2/m1_un5_speciation_rates.log", 
                                 extinction_times_file="output2/m1_un5_extinction_times.log",
                                 extinction_rates_file="output2/m1_un5_extinction_rates.log",
                                 fossilization_times_file="output2/m1_un5_sampling_times.log",
                                 fossilization_rates_file="output2/m1_un5_sampling_rates.log", 
                                 maxAge = 252-66, burnin=0.1,numIntervals=100)
