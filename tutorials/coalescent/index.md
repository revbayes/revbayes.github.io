...
> For plotting with the `R` package `RevGadgets`, please install the package from the "development" branch using devtools: `devtools::install_github("revbayes/RevGadgets", ref = "development")`.
{:.info}
...
> Please create a "figures" directory in the tutorial directory, if you want to plot the results from the exercises.
{:.instruction}
