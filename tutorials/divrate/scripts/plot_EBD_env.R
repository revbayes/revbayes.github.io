...
# path files
speciation_time_file <- paste0("output/primates_EBD_",MODEL,"_env_speciation_times.log")
speciation_rate_file <- paste0("output/primates_EBD_",MODEL,"_env_speciation_rates.log")
extinction_time_file <- paste0("output/primates_EBD_",MODEL,"_env_extinction_times.log")
extinction_rate_file <- paste0("output/primates_EBD_",MODEL,"_env_extinction_rates.log")
...
ggsave(paste0("EBD_",MODEL,"_env.png"), plot = p2, width = 150, height = 120, units = "mm")
