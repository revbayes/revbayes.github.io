...
{% snippet scripts/mcmc_mk_tutorial.Rev %}
...
{% snippet scripts/mcmc_mkv_hyperprior.Rev %}
...
{% snippet scripts/mkv_model_gamma_discretized.Rev %}
...
{% snippet scripts/mcmc_mkv_discretized.Rev %}
