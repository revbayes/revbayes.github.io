...
================================
----------------------
Eclipse is a Java-based, cross-platform IDE with lots of nice features that make it convenient for RevBayes development. 
First, it's is cross-platform, and unlike Xcode, you can use any compiler you like (not just clang).
...
<img src="eclipse-explorer.png" width="50%"></img>
...
![eclipse-path](eclipse-path.png "PATH Configuration")
